...
$string['rf_missing_help']          = 'What to do to students, who already enrolled but do not present in the imported file. (ONLY \'STUDENT\' ROLE AFFECTED)';
...
$string['rf_autowithdraw']          = 'Auto withdraw students from unlisted groups:';
$string['rf_autowithdraw_help']     = 'Should students be withdrawn from groups that are not specified in the imported file. (ONLY \'STUDENT\' ROLE AFFECTED)';
